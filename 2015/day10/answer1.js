...
*/
const originalInput = '3113322113';
var input = originalInput;
var currPattern = '';
var currQty = '';
var output = '';

for (var numTimes = 0; numTimes < 40; numTimes++) {
  currPattern = '';
  currQty = '';
  output = '';
  for (var i = 0; i < input.length; i++) {
    var currLetter = input[i];
    if (currLetter != currPattern) {
      output += currQty.toString() + currPattern;
      currPattern = currLetter;
      currQty = 1;
    } else {
      currQty++;
    }
...
console.log(`${originalInput} becomes ${output}`);
