...
const numOverlappingRanges = lines.reduce((total, curr) => total + (rangeContainsRange(...curr) ? 1 : 0), 0)

console.log(`There are ${numOverlappingRanges} overlapping ranges`) // 595
