...
const execute = (instructions, instructionPointer = 0) => {
  ...
  return execute(instructions, nextInstructionPointer)
}
...
const result = execute(instructions)
console.log({ result }) // 1217
