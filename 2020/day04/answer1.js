...
const fs = require('fs')
fs.writeFileSync('entries.json', JSON.stringify(entries, undefined, 2))

const validEntries = entries.filter(entry => hasRequiredFields(entry))

console.log('validEntries.length', validEntries.length) // 226
